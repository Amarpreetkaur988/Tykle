...
public class GetUsers implements Serializable {
    ...
    public class Detail implements Serializable{
        ...
        @SerializedName("tykleStatus")
        @Expose
        private String tykleStatus;
        ...
        public String getTykleStatus() {
            return tykleStatus;
        }

        public void setTykleStatus(String tykleStatus) {
            this.tykleStatus = tykleStatus;
        }
